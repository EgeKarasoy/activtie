...
type ActivityProfileCardPropType = {
  userId: ?string,
  goActivityDetailProfileCardButton: Function,
  getActivityDetailProfileCardData: Function,
  creatorId: ?string,
  goActivityDetailProfileCardCompletedButton: Function,
  containerStyle: any,
...
class ProfileProfileCard extends Component<ActivityProfileCardPropType> {
  static defaultProps = {
    containerStyle: {},
    tabContainerStyle: {},
  }
  ...
  componentDidMount() {
    const activityDetailProfileCardGoing = this.getActivityDetailProfileCardData;
    activityDetailProfileCardGoing();
    // console.disableYellowBox = true;
  }

  getActivityDetailProfileCardData = (): void =>
    fetch(
      ...
      .then((responseJson: any) => {
        const activityDetailProfileSend = this.props.getActivityDetailProfileCardData;
        activityDetailProfileSend(responseJson);
  ...
  render(): React$Element< * > {
    if (this.props.isGoActivityDetailProfileCard === false) return <ActivityJoin />;
    return (
      <View style={[styles.container, this.props.containerStyle]}>
        <Header>
          <Left>
            <Button transparent onPress={this.props.goActivityDetailProfileCardCompletedButton}>
...
const mapDispatchToProps = (dispatch: ReduxDispatch): MapDispatchToProps => ({
    goActivityDetailProfileCardCompletedButton: () => {
...
const mapStateToProps = (state: StateType): MapStateToProps => ({
  ...
  creatorId: state.profile.creatorId,
  activityDetailProfileCardData: state.profile.activityDetailProfileCardData,
});

export default connect(mapStateToProps, mapDispatchToProps)(ProfileProfileCard);
