...
export default class GateMonitorPassed extends React.Component<
  GateMonitorType,
> {
  componentWillMount() {
  ...
  render(): React$Element< * > {
    ...
    return (
      ...
      >
        <Text>{blank}</Text>
        <FontAwesome name="map-marker" size={25} style={{ color: '#4d4d4d', backgroundColor: 'rgba(52, 52, 52, 0.1)' }}>
          <Text
            style={{
              width: 100,
              height: 25,
